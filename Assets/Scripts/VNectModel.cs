...
public class VNectModel : MonoBehaviour
{
    ...
    private Quaternion InitGazeRoation;
    ...
    // Move in z direction
    private float centerTall = 224 * 0.75f; // 244 : maybe BarracudaRunner._InputImageSize / 2f;
    ...
    public JointPoint[] Init()
    {
        ...
        for (int i = 0; i < PositionIndex.Count.Int(); i++) jointPoints[i] = new JointPoint();
